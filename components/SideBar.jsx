...
const SideBar = ({ children, isOpen, setSideBar }) => {
  return (
    <div>
      <div
        className={`p-5 fixed z-50 top-0 right-0 w-full h-full md:w-1/2 lg:w-[35%] bg-white transition transform duration-700 overflow-y-auto ${isOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        <button
